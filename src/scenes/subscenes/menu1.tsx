...
import { Color, ThreadGenerator, TimingFunction, Vector2, all, any, cancel, chain, createRef, createSignal, decorate, easeInOutQuint, easeInQuint, easeOutCubic, easeOutExpo, easeOutQuint, isThreadGenerator, loop, makeRef, makeRefs, map, range, sequence, threadable, waitFor, waitUntil } from "@motion-canvas/core";
...
export default function* SubScene(view: View2D, earth: Earth, cursor: Cursor): ThreadGenerator {
	...
	yield* Carousel.PopIn(IGroup())
	yield* waitUntil("Menu1-Item0")
	yield* cursor.ClickOn(I[0])
	yield* waitUntil("Menu1-Item1")
	yield* cursor.ClickOn(I[1])
	yield* waitUntil("Menu1-Item2")
	yield* cursor.ClickOn(I[2])
	yield* waitUntil("Menu1-Item3")
	yield* cursor.ClickOn(I[3])
	yield* waitUntil("Menu1-Item4")
	yield* cursor.ClickOn(I[4])
	yield* waitUntil("Menu1-Dialogue1")
	yield* cursor.ClickOn(I[0])
	yield* waitUntil("Menu1-End")
